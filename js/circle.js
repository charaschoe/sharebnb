export function initializeParisCircles(data) {
    ...
    function animateCircles(timestamp) {
        ...
        drawCircle(200, 150, currentAvailableRadius, Math.round((currentAvailableRadius / maxRadius) * 100));
        drawCircle(400, 150, currentNonAvailableRadius, Math.round((currentNonAvailableRadius / maxRadius) * 100));
